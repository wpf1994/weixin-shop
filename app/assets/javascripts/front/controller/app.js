...
angular.module('myapp', ['ngRoute', 'infinite-scroll'])
    ...
    .controller('Mycontroller', ['$rootScope', '$http', function ($rootScope, $http) {
    ...
    .controller('shipping_selected', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
    ...
    .controller('shop_selected', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
        //$scope.shop_info = {}
    ...
    .controller('order_manage', ['$scope', '$http', '$location', '$rootScope', '$timeout', function ($scope, $http, $location, $rootScope, $timeout) {
        $scope.pay_style = 1
        $scope.pay_info_show = false
        ...
        $scope.submit_order_to_down = function () {
            ...
            $rootScope.shop_id = $rootScope.shop_id || null
                $http.post("/front/homes/order_new.json", {
                        ...
                        }, order_detail: {shipping: $rootScope.buy_shipping}, order_express: $rootScope.receving_address,pay_style: $scope.pay_style
                    })
                    .success(function (data) {
                        if (data.result == "OK") {
                            $rootScope.buy_shipping = {}
    ...
    .controller('address_info', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
    ...
    .controller('address_create', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
        $scope.create_address = function () {
    ...
    .controller('person_info', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
        $scope.page = 0;
        $scope.per = 5;
        $scope.busy = false
        $scope.order_old = []
    ...
    .controller('score_detail', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
    ...
    .controller('order_detail', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
        ...
        $scope.pay_order = function(data){
            $http.post('/front/homes/pay_online.json',{id: data})
                .success(function(data){
                    WeixinJSBridge.invoke('getBrandWCPayRequest',data.response,function(res){
                        if(res.err_msg == "get_brand_wcpay_request:ok"){
                            alert("支付成功")
    ...
    .controller('edit_address_manage', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
    ...
    .controller('person_edit', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
        $scope.person_info = {
            name: ''
        }
    ...
    .controller('search_shipping', ['$scope', '$http', '$location', '$rootScope', function ($scope, $http, $location, $rootScope) {
